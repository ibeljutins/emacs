...
(defun igorb/message-mode-hook ()
  ...
  (orgstruct++-mode 1)
  (flyspell-mode 1))
(add-hook  'message-mode-hook 'igorb/message-mode-hook)

(defun igorb/mime/editor-mode-hook ()
...
(add-hook 'mime/editor-mode-hook 'igorb/mime/editor-mode-hook)

(defun igorb/gnus-article-display-hook ()
  ...
  (article-emphasize))
(add-hook 'gnus-article-display-hook 'igorb/gnus-article-display-hook)

(defun igorb/gnus-summary-mode-hook ()
;;  (local-set-key [tab] 'gnus-summary-next-unread-article)
  (save-excursion
    (goto-char (point-min))))
(add-hook 'gnus-summary-mode-hook 'igorb/gnus-summary-mode-hook)
