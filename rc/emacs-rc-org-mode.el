...
(add-hook 'org-mode-hook 'igorb/org-mode-hook)
...
(add-to-list 'org-link-abbrev-alist '("ms-spec" . "http://localhost/~igorb/data-formats-doc/Microsoft%20Specs/[%s].pdf"))
...
;; (defun igorb/org-agenda-to-appt ()
;;   (interactive)
;;   (setq appt-time-msg-list nil)
;;   (org-agenda-to-appt))

;; (add-hook 'org-finalize-agenda-hook 'igorb/org-agenda-to-appt)
;; (igorb/org-agenda-to-appt)
;; (run-at-time "24:01" nil 'igorb/org-agenda-to-appt)
