...
(defun igorb/muse-mode-hook ()
  (auto-fill-mode -1)
  (longlines-mode -1)
  (footnote-mode 1)
  )
(add-hook 'muse-mode-hook 'igorb/muse-mode-hook)
(add-hook 'muse-mode-hook 'igorb/common-hook)
(add-hook 'muse-mode-hook 'igorb/show-prog-keywords)
...
(defun igorb/muse-replace-text (from to)
  (save-excursion
...
(defun igorb/muse-convert-docbook ()
  (interactive)
  (mapcar (lambda (x) (igorb/muse-replace-text (car x) (cdr x)))
...
(defun igorb/blorg-publish-file (fname)
  (save-excursion
...
;;       (progn
;;         (igorb/blorg-publish-file "~/Dropbox/my-page-muse/ru/news/news.org")
;;         (igorb/blorg-publish-file "~/Dropbox/my-page-muse/en/news/news.org"))))
