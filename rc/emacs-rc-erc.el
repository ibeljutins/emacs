...
(setq erc-user-full-name "Igor Bel")
(setq erc-email-userid "igorb@gmail.com")
...
(setq erc-max-buffer-size 20140)
...
(defun erc-connect ()
  ...
  (interactive)
  (progn
;;    (erc-select :server "irc.int.ru" :port 6667 :nick "igorb")
    (erc-select :server "irc.freenode.net" :port 6667 :nick "igorb")
;;    (erc-select :server "irc.fu-berlin.de" :port 6667 :nick "igorb")
  ))
