...
(let ((*background-color*  "#ffffff")
  ...
  (custom-theme-set-faces
   ...
   `(quack-about-face ((t (:family "Droid Sans Mono"))))
   `(quack-about-title-face ((t (:bold t :foreground "#008000" :weight bold :height 2.0 :family "Droid Sans Mono"))))
   `(quack-banner-face ((t (:family "Droid Sans Mono"))))
   `(quack-pltfile-dir-face ((t (:bold t :background "gray33" :foreground "white" :weight bold :height 1.2 :family "Droid Sans Mono"))))
   `(quack-pltfile-file-face ((t (:bold t :background "gray66" :foreground "black" :weight bold :height 1.2 :family "Droid Sans Mono"))))
