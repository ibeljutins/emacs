...
(let ((*background-color*  "#ffffff")
  ...
  (custom-theme-set-faces
   ...
   `(quack-about-face ((t (:family "Ubuntu Mono"))))
   `(quack-about-title-face ((t (:bold t :foreground "#008000" :weight bold :height 2.0 :family "Ubuntu Mono"))))
   `(quack-banner-face ((t (:family "Ubuntu Mono"))))
   `(quack-pltfile-dir-face ((t (:bold t :background "gray33" :foreground "white" :weight bold :height 1.2 :family "Ubuntu Mono"))))
   `(quack-pltfile-file-face ((t (:bold t :background "gray66" :foreground "black" :weight bold :height 1.2 :family "Ubuntu Mono"))))
   ...
   `(quack-threesemi-h1-face ((t (:bold t :weight bold :height 1.4 :family "Ubuntu Mono"))))
   `(quack-threesemi-h2-face ((t (:bold t :weight bold :height 1.2 :family "Ubuntu Mono"))))
   `(quack-threesemi-h3-face ((t (:bold t :weight bold :family "Ubuntu Mono"))))
